...
class _DoubleBackToCloseAppState extends State<DoubleBackToCloseApp> {
  ...
  bool get _isSnackBarVisible => (_lastTimeBackButtonWasTapped != null) && (widget.snackBar.duration > DateTime.now().difference(_lastTimeBackButtonWasTapped));
  ...
  bool get _willHandlePopInternally => ModalRoute.of(context).willHandlePopInternally;
