                  ...
                  child: AlertStyleWidget(
                      ...
                      actions: <Widget>[
                        if (Upgrader().showIgnore)
                          TextButton(
                              child: Text(Upgrader().messages!.message(UpgraderMessage.buttonTitleIgnore) ?? ''),
                              onPressed: () {
                        ...
                        if (Upgrader().showLater)
                          TextButton(
                              child: Text(Upgrader().messages!.message(UpgraderMessage.buttonTitleLater) ?? ''),
                              onPressed: () {
                                // Save the date/time as the last time alerted.
                                Upgrader().saveLastAlerted();
                        ...
                        TextButton(
                            child: Text(Upgrader().messages!.message(UpgraderMessage.buttonTitleUpdate) ?? ''),
                            onPressed: () {
                              // Save the date/time as the last time alerted.
                              Upgrader().saveLastAlerted();
