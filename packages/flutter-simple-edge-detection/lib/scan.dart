...
class _ScanState extends State<Scan> {
  ...
  Widget _getMainWidget() {
    ...
    if (croppedImagePath != null) {
      widget = ImageView(imagePath: croppedImagePath);
    }

    if (imagePath == null && edgeDetectionResult == null) {
      widget = CameraView(controller: controller);
    }
  ...
  Padding _getBottomBar() {
    return Padding(padding: EdgeInsets.only(bottom: 32), child: Align(alignment: Alignment.bottomCenter, child: _getButtonRow()));
  }
}
